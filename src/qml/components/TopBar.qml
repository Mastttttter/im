...
Rectangle {
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Button {
                text: "复制"
                onClicked: controller.copySelfId()
            }
            Label {
                text: controller.networkStatus
                color: theme.muted
        ...
        RowLayout {
            ...
            Button {
                text: "更换密码"
                onClicked: root.changePasswordRequested()
            }
            Button {
                text: "删除好友"
            ...
            Button {
                text: "创建群聊"
                onClicked: controller.createGroup("群聊")
            }
            Button {
                text: "邀请入群"
                onClicked: controller.inviteSelectedFriendToGroup()
            }
            Button {
                text: "退出群聊"
                onClicked: controller.leaveSelectedGroup()
            }
            Item {
                Layout.fillWidth: true
            }
